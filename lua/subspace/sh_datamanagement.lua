local Singularity = Singularity --Gonna Need all the speed we can get.

Singularity.Persist = Singularity.Persist or {}
local Persist = Singularity.Persist

Persist.DataFolder = "Singularitydata"
